...
# Build HTML with Sleek Ultra-Thin 5 Tabs
html = f"""<!DOCTYPE html>
<html lang="vi">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Mẹo Học & Quy Tắc Khoanh Trắc Nghiệm Triết Học Mác - Lênin (5 Tab Thon Gọn)</title>
...
<body>
  ...
  <nav class="tab-bar">
    ...
    <button class="tab-item" data-sec="sec3">
      ...
      <span>3: Từ Khóa Vàng</span>
      <small>Khoanh ngay</small>
    </button>
...
print("Successfully generated ultra-thin sleek 5-Tab meo_hoc.html!")
